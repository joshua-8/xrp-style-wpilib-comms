...
xrp_motor_t motor3_3_data = { .id = 1, .value = 0.0 };
xrp_motor_t motor4_4_data = { .id = 2, .value = 0.0 };
xrp_motor_t motor7_R_data = { .id = 3, .value = 0.0 };
...
void processDataReceived()
{
    ...
    xswc.getData_xrp_motor(motor3_3_data, 1);
    xswc.getData_xrp_motor(motor4_4_data, 2);
    xswc.getData_xrp_motor(motor7_R_data, 3);
